  ...
  public static void main(String[] args) {
    ...
    Spieler spieler1 =
        new Spieler(
            "Manuel Müller",
            9,
            new String[] {"Auto", "Pistole", "Taschenlampe"},
    ...
    System.out.println(
        spieler1.getName()
            ...
            + spieler1.getLevel()
            + " und spielt einen "
            + spieler1.getKlasse().getKlassenName()
            + " und gehört zur Spezies: "
            + spieler1.getSpezies().getBezeichnung());
    System.out.println(
        spieler2.getName()
            + " ist Level "
            + spieler2.getLevel()
            + " und spielt eine "
            + spieler2.getKlasse().getKlassenName()
            + "in und gehört zur Spezies: "
            + spieler2.getSpezies().getBezeichnung());
  }
}
